...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Address.address2'
        db.alter_column(u'stores_address', 'address2', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'Address.address3'
        db.alter_column(u'stores_address', 'address3', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Address.address2'
        db.alter_column(u'stores_address', 'address2', self.gf('django.db.models.fields.CharField')(default='', max_length=200))

        # Changing field 'Address.address3'
        db.alter_column(u'stores_address', 'address3', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
