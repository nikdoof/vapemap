...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Chain.long_description'
        db.alter_column(u'stores_chain', 'long_description', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Store.phone'
        db.alter_column(u'stores_store', 'phone', self.gf('django.db.models.fields.CharField')(max_length=25, null=True))

        # Changing field 'Store.long_description'
        db.alter_column(u'stores_store', 'long_description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Chain.long_description'
        db.alter_column(u'stores_chain', 'long_description', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Store.phone'
        db.alter_column(u'stores_store', 'phone', self.gf('django.db.models.fields.CharField')(default='', max_length=25))

        # Changing field 'Store.long_description'
        db.alter_column(u'stores_store', 'long_description', self.gf('django.db.models.fields.TextField')(default=''))
