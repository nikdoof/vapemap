...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm['waffle.Switch'].objects.create(name='claim_support', note="Enables support to claim stores/chains.")
        orm['waffle.Switch'].objects.create(name='uservoice_tab', note="Shows the UserVoice tab.")
        orm['waffle.Switch'].objects.create(name='map_geolocation', note='Enables geolocation searching on the main map view')

    def backwards(self, orm):
        orm['waffle.Switch'].objects.filter(name__in=['claim_support', 'uservoice_tab', 'map_geolocation']).delete()
